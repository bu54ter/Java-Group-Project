...
public class LecturerController {
	...
	private final UserRepository userRepository;
	 ...
	 public LecturerController(NounRepository nounRepository, NounService nounService, NounDeletedRepository nounDeletedRepository, UserRepository userRepository) {
	 ...
	 public String createNoun(@ModelAttribute("noun") Nouns noun,
	     ...
	     noun.setCreatedBy(user.getUserId()); // Long ID
