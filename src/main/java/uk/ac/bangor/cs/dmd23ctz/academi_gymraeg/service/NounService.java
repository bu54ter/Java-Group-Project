 ...
 *     <li>Tracking audit information such as created, edited, and deleted by users</li>
 * </ul>
 */
@Service
public class NounService {
     ...
     * @throws RuntimeException if the noun or user cannot be found, or if the noun is already deleted
     */
	@Transactional
