 ...
 *
 * <p>This controller provides the "word of the day" feature by selecting
 * a random {@link Nouns} entry and caching it for the current day.</p>
 */
@Controller
public class HomeController {
     ...
     *
     * <p>A new noun is selected only if:
     * <ul>
     *     <li>No noun has been selected yet</li>
     *     <li>The current date differs from the stored date</li>
     * </ul>
     *
     * <p>The selected noun is cached for the duration of the day
     * to ensure consistency across requests.</p>
     *
     ...
     *
     * <p>This method retrieves the current "word of the day" and adds it
     * to the model for display on the homepage.</p>
     *
